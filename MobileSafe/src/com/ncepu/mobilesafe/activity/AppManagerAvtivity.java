 ...
 *
 */
public class AppManagerAvtivity extends Activity implements OnClickListener{
	/**
	 * xUtils 中注解方式 绑定id
	 */
	...
	private class AppManagerAdpter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.iv_iconn.setBackground(appInfo.getIcon());//此方法在安卓4.1以上有效。在资源文件中默认icon不可设为src，否则会重叠
			//holder.iv_iconn.setBackgroundDrawable(appInfo.getIcon());过时，但是低版本有效。
